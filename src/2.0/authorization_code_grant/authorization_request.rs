...
use crate::v2_0::authorization_code_grant::{pkce::Oauth20PkceCodeChallenge, state::Oauth20State};
...
///
/// Refs: <https://datatracker.ietf.org/doc/html/rfc6749#section-4.1.1>
pub struct Oauth20AuthorizationRequestParams<'a> {
...
impl Oauth20AuthorizationRequestParams<'_> {
